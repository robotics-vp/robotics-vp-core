...
- `src/vision/reconstruction/four_d_reconstruction.py` now emits `reconstruction_grounding_report_v1` eligibility reports so calibration and real-grounding classes are explicit before replay/export or future training consumption.
