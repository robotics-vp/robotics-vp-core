...
- `scripts/export_governed_video_stage1_bridges.py` now exports governed-video admission logs into canonical replay plus RLDS and LeRobot rows while preserving internal sidecar refs, benchmark-gate payloads, and future-training signals.
