...
The 2026-05-20 integration pass added Stage-1 teacher-runtime contract/action/trace sidecars, stopped fabricating calibration refs in default reconstruction sidecars, threaded reconstruction/teacher refs through replay discovery, and added a governed-video bridge export script that writes canonical replay plus RLDS and LeRobot rows while preserving internal sidecar refs.

## Remaining before Economic WM

- Run fuller replay/export sweeps over more Stage-1 examples and real manifest shapes.
- Keep tightening real SceneTracks and calibration truth at ingestion/runner boundaries.
