...
- Economic WM scaffold, local row materialization, shadow allocation evals, evidence-contract prep, runbook-template compilation, template validation, canonical lower-WM consumption preflights, native lower-WM ref preservation, neural manifest scaffolding, resource receipt surfaces, Phase-5 local prep rows, trainer scaffold contracts, and shadow execution work orders now exist behind the entry preflight; training remains blocked until GPU/provider bring-up, non-stub teacher/runtime evidence, and promotion-grade benchmark evidence exist.
