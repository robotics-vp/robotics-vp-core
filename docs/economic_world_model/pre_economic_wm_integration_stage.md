...
- Economic WM scaffold, local row materialization, shadow allocation evals, evidence-contract prep, runbook-template compilation, template validation, canonical lower-WM consumption preflights, native lower-WM ref preservation, and neural manifest scaffolding may continue behind the entry preflight; training remains blocked until GPU/provider bring-up, non-stub teacher/runtime evidence, and promotion-grade benchmark evidence exist.
