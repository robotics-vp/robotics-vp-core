...
- Economic WM scaffold, local row materialization, shadow allocation evals, evidence-contract prep, and runbook-template compilation may continue behind the entry preflight; training remains blocked until GPU/provider bring-up, non-stub teacher/runtime evidence, and promotion-grade benchmark evidence exist.
