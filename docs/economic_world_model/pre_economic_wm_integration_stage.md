...
- Economic WM scaffold, local row materialization, shadow allocation evals, evidence-contract prep, runbook-template compilation, and template validation may continue behind the entry preflight; training remains blocked until GPU/provider bring-up, non-stub teacher/runtime evidence, and promotion-grade benchmark evidence exist.
