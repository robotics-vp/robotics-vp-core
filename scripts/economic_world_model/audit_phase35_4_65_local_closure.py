...
def _write_markdown(path: Path, payload: Mapping[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "## Boundary",
            "",
            "This audit closes local scaffolding only. It may include a minimal",
            "local no-policy MuJoCo headless step if the runtime bridge report",
            "actually emitted one, but it does not claim deployment-grade Unitree",
