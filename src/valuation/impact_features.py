...
def batch_impact_features(episodes: List[Dict[str, Any]]) -> tuple[np.ndarray, List[str]]:
    """
...
def compute_impact_deltas(
    cluster_episodes: List[Dict[str, Any]], all_episodes: List[Dict[str, Any]]
) -> Dict[str, float]:
    """
    ...
    for name in feature_names:
        ...
        deltas[f"delta_{name}"] = float(cluster_mean - global_mean)
