"""Concrete realization over Holosoma adapter execution mediation."""
...
LOCAL_BACKEND_NAME = "holosoma"
LOCAL_BACKEND_FACTORY = "src.motor_backend.factory:make_motor_backend"
LOCAL_BRIDGE_MODULE = "holosoma"
EXTERNAL_DELEGATE_RUNNER = "scripts/local_holosoma_smoke.py"


def build_holosoma_adapter_realization(
    *,
    ...
    if execution_path == "local_runtime_binding":
        realization_path = "local_backend_factory"
        if adapter_status in {
            "local_runtime_binding_ready",
            "local_runtime_binding_handed_off",
        }:
