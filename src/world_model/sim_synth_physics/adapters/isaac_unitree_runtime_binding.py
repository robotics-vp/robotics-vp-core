    ...
    *,
    ...
    deploy_selection = select_best_named_ref(
        [
            ...
            *_named_candidates(
                "pack.deploy_candidates", strings(pack.get("deploy_candidates"))
            ),
            *_named_candidates(
    ...
    selected_ref_evidence = {
        ...
        "deploy_config_ref": _optional_mapping(deploy_selection.get("evidence")),
